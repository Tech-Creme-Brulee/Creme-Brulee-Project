...
module.exports = function (app) {
  ...
  // DELETE route for deleting reviews. We can get the id of the Comment to be deleted from
  // req.params.id
  ...
  // PUT route for updating reviews. We can get the updated Comment data from req.body
